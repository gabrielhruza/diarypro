...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.exception_subscriber' => 'getApp_ExceptionSubscriberService',
    ...
    /**
     * Gets the 'app.exception_subscriber' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\EventSubscriber\ExceptionSubscriber A AppBundle\EventSubscriber\ExceptionSubscriber instance.
     */
    protected function getApp_ExceptionSubscriberService()
    {
        return $this->services['app.exception_subscriber'] = new \AppBundle\EventSubscriber\ExceptionSubscriber();
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addSubscriberService('app.exception_subscriber', 'AppBundle\\EventSubscriber\\ExceptionSubscriber');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'diarypro', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_58aa6f73059c8fd9a9469dfe633a1a203140e91677e94a0d747e3b723fe57d0a');
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'form_themes' => array(0 => 'form_div_layout.html.twig', 1 => 'LexikFormFilterBundle:Form:form_div_layout.html.twig'), 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape' => 'filename', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array(), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('891b144cb99171dfe6c8e3c9f0da2af26ede59e5');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '891b144cb99171dfe6c8e3c9f0da2af26ede59e5',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '891b144cb99171dfe6c8e3c9f0da2af26ede59e5',
