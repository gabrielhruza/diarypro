 ...
 */
class CorreoElectronico extends \AppBundle\Entity\CorreoElectronico implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CorreoElectronico' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\CorreoElectronico' . "\0" . 'prioridad', '' . "\0" . 'AppBundle\\Entity\\CorreoElectronico' . "\0" . 'direccion', '' . "\0" . 'AppBundle\\Entity\\CorreoElectronico' . "\0" . 'profesional'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CorreoElectronico $proxy) {
