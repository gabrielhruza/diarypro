 ...
 */
class Telefono extends \AppBundle\Entity\Telefono implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Telefono' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Telefono' . "\0" . 'prioridad', '' . "\0" . 'AppBundle\\Entity\\Telefono' . "\0" . 'numero', '' . "\0" . 'AppBundle\\Entity\\Telefono' . "\0" . 'celular', '' . "\0" . 'AppBundle\\Entity\\Telefono' . "\0" . 'profesional'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Telefono $proxy) {
