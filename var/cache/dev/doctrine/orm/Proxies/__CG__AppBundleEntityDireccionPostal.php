 ...
 */
class DireccionPostal extends \AppBundle\Entity\DireccionPostal implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\DireccionPostal' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\DireccionPostal' . "\0" . 'prioridad', '' . "\0" . 'AppBundle\\Entity\\DireccionPostal' . "\0" . 'provincia', '' . "\0" . 'AppBundle\\Entity\\DireccionPostal' . "\0" . 'localidad', '' . "\0" . 'AppBundle\\Entity\\DireccionPostal' . "\0" . 'codPostal', '' . "\0" . 'AppBundle\\Entity\\DireccionPostal' . "\0" . 'calle', '' . "\0" . 'AppBundle\\Entity\\DireccionPostal' . "\0" . 'numero', '' . "\0" . 'AppBundle\\Entity\\DireccionPostal' . "\0" . 'profesional'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DireccionPostal $proxy) {
